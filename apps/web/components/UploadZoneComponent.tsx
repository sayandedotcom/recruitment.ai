...
import { useUploadFileData } from "@/hooks/requests";
        ...
        <div className="bg-white dark:bg-gray-400 rounded w-full mx-auto">
          <div className="relative flex flex-col p-4 text-gray-400 border border-gray-200 rounded">
            <form onSubmit={handleSubmitUpload}>
                      ...
                      {file.length !== 0 ? (
                        file.map((file, i) => (
                          <>
                            <div
                              key={i}
                              className="flex flex-col ml-2 mr-2 justify-center items-center border w-2/12"
                            >
                              <Image
                        ...
                        <div className="flex text-center">
                          <File className="dark:text-white w-6 h-6 mr-2" />
              ...
              {file && !isUpload && (
                <div className="pt-4 flex justify-center items-start gap-3 text-center">
